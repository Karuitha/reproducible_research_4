...
\begin{flushleft}
{\Large
\textbf\newline{Financial Development and the Uptake of Microfinance in
...
\\
Simon Kamau\textsuperscript{\getAff{Some Institute of
Technology}}\textsuperscript{*},
John Karuitha\textsuperscript{\getAff{Another University}, \getAff{Some
