...
\begin{flushleft}
{\Large
\textbf\newline{Financial Development and Financial Inclusion in
Africa} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
John Karuitha\textsuperscript{\getAff{1}, \getAff{2}},
Kalu Ojah\textsuperscript{\getAff{2}}\\
\bigskip
\textbf{\getAff{1}}\emph{Graduate School of Business Administration,
University of the Witwatersrand, Johannesburg, 2nd St Davids Place,
Parktown, 2050, Johannesburg, South Africa.}\\
\textbf{\getAff{2}}\emph{Karatina University, P.O. Box 1957-10101,
Karatina, Kenya.}\\
\bigskip
\end{flushleft}
